...
Symmetric GARCH(1,1) with Student-t innovations on percent log returns.
...
| MAE | 0.016439 |
| RMSE | 0.023375 |
| MASE (naive = 1) | 1.002747 |
| skill vs naive | -0.002747 |
| forecast bias | 0.000824 |
...
- Diebold-Mariano statistic 0.999, p = 0.3183, q = 0.3879 after Benjamini-Hochberg
- **Verdict**: not distinguishable from the naive baseline

## Stability

- mean skill across blocks -0.002854
- worst block -0.005862
...
- 1672 bytes, sha256 `2c333e7077173bbc`
